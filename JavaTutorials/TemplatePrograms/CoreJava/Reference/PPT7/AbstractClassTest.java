...
/**
 * Program Description: This program is to show how abstract class is created
 * 
 * Author: Vikas 
 * Written: 02/09/2015 
 * Last Updated:
 * 
 * Compilation: javac AbstractClassTest.java 
 * Execution: java AbstractClassTest
 * Output:
 */
...
/* abstract class must be extended from a concrete class for its completion */
