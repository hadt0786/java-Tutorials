...
* Author: Vikas
* Program Detail: The code is to show how jvm excutes the static members in case inheritance
* Referece: "Java Virtual Machine Delving Deep into its Architecture" Article published in OSFY in December 2014 at page 55

*/

/*the order of identification and execution of static members in case of inheritance will from top to bottom or from parent class to child class*/
