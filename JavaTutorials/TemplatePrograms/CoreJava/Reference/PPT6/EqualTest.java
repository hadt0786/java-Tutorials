...
/**
 * Program Description: the program is to show the implementation of equals()
 * method and == operator
 * 
 * Author: Vikas Written: 09/02/2015 Last Updated:
 * 
 * Compilation: javac EqualTest.java 
 * Execution: java EqualTest 
 * Output:
 */
...
public class EqualTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * equals() method compares string to the specified object. The result
