...
* Program Description: this program is to show how we can order the collection objects with the help of Comparable interface 
* @Author: Vikas

*/

import java.util.*; // TreeSet class is present inside the java.util package
