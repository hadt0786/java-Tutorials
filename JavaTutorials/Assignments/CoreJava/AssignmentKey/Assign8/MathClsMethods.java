//Write Java program to show uses of all Math class methods

public class MathClsMethods
 {

    public static void main(String[] args)
    {
       System.out.println("*********  Trigonometric Functions  *********");
       System.out.println("Sin(45) in radian = " + Math.sin(45) );
       System.out.println("Cos(45) in radian = " + Math.cos(45) );
       System.out.println("Tan(45) in radian = " + Math.tan(45) );
